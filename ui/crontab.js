...
crontab = function(name, recipient, type, amount, description, command, schedule, stopped, logging, mailing){
	var data = {};
	data.name = name;
...
exports.create_new = function(name, recipient, type, amount, description, command, schedule, logging, mailing){
	var tab = crontab(name, recipient, type, amount, description, command, schedule, false, logging, mailing);
...
exports.update = function(data){
	var tab = crontab(data.name, data.recipient, data.type, data.amount, data.description, data.command, data.schedule, null, data.logging, data.mailing);
	tab.saved = false;
